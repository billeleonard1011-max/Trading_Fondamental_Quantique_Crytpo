...
CHOIX_INTERPRETATION: Final[tuple[dict[str, str], ...]] = (
    {
        ...
        "choix": (
            "L'origine retenue est l'extrême le plus éloigné de l'order block "
            "atteint entre sa formation et son contact : le point d'où le prix "
            "a fait demi-tour vers la zone."
        ),
    },
    {
